export const schoolConfig = {
  schoolName: import.meta.env.VITE_SCHOOL_NAME || "Keshavnagar School No 1",
  tagline: "Nurturing young minds with care, discipline, and joyful learning.",
  shortDescription:
    "A welcoming primary school in Keshav Nagar, Ahmedabad, focused on strong foundations, student confidence, and community values.",
  address:
